...
from custom_statistics_functions import multi_comparisons_letter_df_generator, post_hoc_df
...
if __name__ == "__main__":
    ...
    df.rename(columns = {'lifeExp': "Life expectency (years)", 'pop':'Population'}, inplace = True)
                         
    #list column names in appropiate test list                     
    tukey_Y_cols = ['Life expectency (years)']
